    ...
    <>
        ...
        <>
          ...
          <ul>
            ...
            <li>
              ...
              earnings on all your lending, awarded in KASU (subject to change
          ...
          <ul>
            ...
            <li>
              ...
              awarded in KASU (subject to change according to liquidity demand
      ...
      {loyalityLevel === 1 && (
        <>
          ...
          <Typography variant='inherit'>
            Should you unlock any amount of KASU, your rKASU will be burned in
            ...
            of Loyalty Level.
            <br />
            Regardless of your Loyalty Level, your rKASU balance, relative to
            the total combined rKASU balance of all Lenders in the Kasu
            ecosystem, also determines your share of Protocol Fees.
          </Typography>
        </>
      )}
      {loyalityLevel === 2 && (
