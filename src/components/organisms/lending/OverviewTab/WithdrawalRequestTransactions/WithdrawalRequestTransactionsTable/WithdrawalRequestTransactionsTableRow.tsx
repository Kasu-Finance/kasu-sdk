...
type WithdrawalRequestTransactionsTableRowProps = {
  transactionWrapper: WithdrawalTransactionWrapper
  currentEpoch: string
}

const WithdrawalRequestTransactionsTableRow: React.FC<
  WithdrawalRequestTransactionsTableRowProps
...
export default WithdrawalRequestTransactionsTableRow
