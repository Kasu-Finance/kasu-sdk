      ...
      <OrderedList sx={{ pl: 1.5 }}>
        <li>
          ...
          <Typography variant='baseSm' display='block' mt={1}>
            ...
            {t(
              'modals.loanContract.subheader-3.list.list-0.list-0-list.list-0-list-0.list-2.description'
            )}
          </Typography>
          <Typography variant='baseSm' display='block' mt={1}>
            <strong>
            ...
            {t(
              'modals.loanContract.subheader-3.list.list-0.list-0-list.list-0-list-0.list-3.description'
            )}
          </Typography>
          <Typography variant='baseSm' display='block' mt={1}>
            <strong>
            ...
            {t(
              'modals.loanContract.subheader-3.list.list-0.list-0-list.list-0-list-0.list-4.description'
            )}
          </Typography>
          <Typography variant='baseSm' display='block' mt={1}>
            <strong>
